					...
					<div class="table-responsive">
						...
						<form action="" method="POST">
							<div class="input-group mb-3">
							  ...
							  <input id="inputGroupSelect03" type="number" class="form-control" placeholder="Taka" name="">
							  <label class="input-group-text" for="inputGroupSelect03">/=</label>
							</div>
							<input type="submit" class="btn btn-outline-danger ms-4 my-3" value="Add" name="">
						</form>
					</div>
				</div>
			</div>
